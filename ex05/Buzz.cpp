...
** Last update Mon Jan 18 15:53:46 2016 Marlon Petit
*/
...
void	Buzz::speak(std::string sent)
{
  std::cout << "BUZZ: " << this->name << " \"" << sent << "\"" << std::endl;
}

bool	Buzz::speak_es(std::string sent)
{
  std::cout << "BUZZ: " << this->name << " senorita \"" << sent << "\" senorita" << std::endl;
  return (true);
}
